...
ST.seedSampleData = function() {
  ...
  var sampleMenu = [
    /* กาแฟ */
    { id: 'm_americano', name: 'อเมริกาโน่', catId: 'cat_coffee', emoji: '☕', image: 'https://i.ibb.co/mCZsdwrC/Americano.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 1, created: todayStr() },
    { id: 'm_latte', name: 'ลาเต้', catId: 'cat_coffee', emoji: '🥛', image: 'https://i.ibb.co/svBZVdvq/Latte.png', prices: { S: 70, M: 80, L: 90 }, cost: 22, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 2, created: todayStr() },
    { id: 'm_cappuccino', name: 'คาปูชิโน่', catId: 'cat_coffee', emoji: '☕', image: 'https://i.ibb.co/7MBQx0N/Cappuccino.png', prices: { S: 70, M: 80, L: 90 }, cost: 22, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 3, created: todayStr() },
    { id: 'm_mocha', name: 'มอคค่า', catId: 'cat_coffee', emoji: '🍫', image: 'https://i.ibb.co/nsZ0Zz6g/Mocha.png', prices: { S: 80, M: 90, L: 100 }, cost: 28, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 4, created: todayStr() },
    { id: 'm_caramel_macchiato', name: 'คาราเมล มัคคิอาโต้', catId: 'cat_coffee', emoji: '🍯', image: 'https://i.ibb.co/sJ6Rxf4B/Caramel-Macchiato.png', prices: { S: 85, M: 95, L: 105 }, cost: 30, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 5, created: todayStr() },
    { id: 'm_white_mocha', name: 'ไวท์ช็อคโกแลต มอคค่า', catId: 'cat_coffee', emoji: '🤍', image: 'https://i.ibb.co/xqZcZ3dt/White-Chocolate-Mocha.png', prices: { S: 90, M: 100, L: 110 }, cost: 32, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 6, created: todayStr() },
    { id: 'm_espresso', name: 'เอสเพรสโซ่', catId: 'cat_coffee', emoji: '☕', image: 'https://i.ibb.co/0yjJ4kqh/Espresso.png', prices: { S: 50 }, cost: 12, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot'], allowSweetLevel: false, sort: 7, created: todayStr() },
    { id: 'm_iced_americano', name: 'อเมริกาโน่เย็น', catId: 'cat_coffee', emoji: '🧊', image: 'https://i.ibb.co/YBgSGFLh/Iced-Americano.png', prices: { S: 65, M: 75, L: 85 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced'], allowSweetLevel: true, sort: 8, created: todayStr() },
    /* ชา */
    { id: 'm_greentea', name: 'ชาเขียว', catId: 'cat_tea', emoji: '🍵', image: 'https://i.ibb.co/7JK2mNkB/Green-Tea.png', prices: { S: 65, M: 75, L: 85 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 9, created: todayStr() },
    { id: 'm_thaitea', name: 'ชาไทย', catId: 'cat_tea', emoji: '🧋', image: 'https://i.ibb.co/3ythjkQp/Thai-Tea.png', prices: { S: 55, M: 65, L: 75 }, cost: 15, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 10, created: todayStr() },
    { id: 'm_lemontea', name: 'ชามะนาว', catId: 'cat_tea', emoji: '🍋', image: 'https://i.ibb.co/Z9F2XHT/Lemon-Tea.png', prices: { S: 50, M: 60, L: 70 }, cost: 12, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced'], allowSweetLevel: true, sort: 11, created: todayStr() },
    { id: 'm_blacktea', name: 'ชาดำ', catId: 'cat_tea', emoji: '🫖', image: 'https://i.ibb.co/ks9xnyjy/Black-Tea.png', prices: { S: 45, M: 55, L: 65 }, cost: 10, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 12, created: todayStr() },
    { id: 'm_milktea', name: 'ชานม', catId: 'cat_tea', emoji: '🥛', image: 'https://i.ibb.co/zH8VDJQw/Milk-Tea.png', prices: { S: 55, M: 65, L: 75 }, cost: 15, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 13, created: todayStr() },
    { id: 'm_matcha_latte', name: 'มัทฉะ ลาเต้', catId: 'cat_tea', emoji: '🍵', image: 'https://i.ibb.co/ynTPfWdh/Matcha-Latte.png', prices: { S: 80, M: 90, L: 100 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 14, created: todayStr() },
    { id: 'm_greentea_latte', name: 'ชาเขียวนม', catId: 'cat_tea', emoji: '🍵🥛', image: 'https://i.ibb.co/JwGmDzWN/Green-Tea-Latte.png', prices: { S: 70, M: 80, L: 90 }, cost: 20, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 15, created: todayStr() },
    /* ปั่น */
    { id: 'm_cocoa', name: 'โกโก้', catId: 'cat_blend', emoji: '🍫', image: 'https://i.ibb.co/5xzXyRvH/Cocoa.png', prices: { S: 75, M: 85, L: 95 }, cost: 20, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 16, created: todayStr() },
    { id: 'm_hot_chocolate', name: 'ฮ็อตช็อคโกแลต', catId: 'cat_blend', emoji: '☕', image: 'https://i.ibb.co/yFhjptXD/Hot-Chocolate.png', prices: { S: 80, M: 90, L: 100 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot'], allowSweetLevel: true, sort: 17, created: todayStr() },
    { id: 'm_strawberry_smoothie', name: 'สมูทตี้สตรอเบอร์รี่', catId: 'cat_blend', emoji: '🍓', image: 'https://i.ibb.co/XxXBzXBG/Strawberry-Smoothie.png', prices: { S: 85, M: 95, L: 105 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 18, created: todayStr() },
    { id: 'm_blueberry_smoothie', name: 'สมูทตี้บลูเบอร์รี่', catId: 'cat_blend', emoji: '🫐', image: 'https://i.ibb.co/67YZn4jt/Blueberry-Smoothie.png', prices: { S: 85, M: 95, L: 105 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 19, created: todayStr() },
    { id: 'm_mango_smoothie', name: 'สมูทตี้มะม่วง', catId: 'cat_blend', emoji: '🥭', image: 'https://i.ibb.co/9ks2XMP5/Mango-Smoothie.png', prices: { S: 85, M: 95, L: 105 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 20, created: todayStr() },
    /* เบเกอรี่ */
    { id: 'm_croissant', name: 'ครัวซองค์', catId: 'cat_bakery', emoji: '🥐', image: 'https://i.ibb.co/qMpWL3ZK/Croissant.png', prices: { S: 65 }, cost: 25, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 21, created: todayStr() },
    { id: 'm_chocolate_cake', name: 'เค้กช็อกโกแลต', catId: 'cat_bakery', emoji: '🍰', image: 'https://i.ibb.co/hx3n2rGS/Chocolate-Cake.png', prices: { S: 120 }, cost: 40, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 22, created: todayStr() },
    { id: 'm_cookie', name: 'คุกกี้', catId: 'cat_bakery', emoji: '🍪', image: 'https://i.ibb.co/Y7SJgJnk/Cookie.png', prices: { S: 45 }, cost: 15, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 23, created: todayStr() },
    { id: 'm_brownie', name: 'บราวนี่', catId: 'cat_bakery', emoji: '🍫', image: 'https://i.ibb.co/nsW3r0nC/Brownie.png', prices: { S: 55 }, cost: 20, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 24, created: todayStr() },
    { id: 'm_cheesecake', name: 'ชีสเค้ก', catId: 'cat_bakery', emoji: '🧀', image: 'https://i.ibb.co/ycbWQ3SF/Cheesecake.png', prices: { S: 110 }, cost: 35, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 25, created: todayStr() },
    /* อื่นๆ */
