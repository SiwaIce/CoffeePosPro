...
ST.getConfig = function() {
  var defaults = {
    ...
    menuNameLang: 'th',          // 'th' (ไทย) / 'en' (อังกฤษ) — ภาษาที่ใช้แสดงชื่อเมนู
...
ST.seedSampleData = function() {
  ...
  var sampleMenu = [
    /* กาแฟ */
    { id: 'm_americano', name: 'อเมริกาโน่', nameEn: 'Americano', catId: 'cat_coffee', emoji: '☕', image: 'https://i.ibb.co/mCZsdwrC/Americano.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 1, created: todayStr() },
    { id: 'm_latte', name: 'ลาเต้', nameEn: 'Latte', catId: 'cat_coffee', emoji: '🥛', image: 'https://i.ibb.co/svBZVdvq/Latte.png', prices: { S: 70, M: 80, L: 90 }, cost: 22, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 2, created: todayStr() },
    { id: 'm_cappuccino', name: 'คาปูชิโน่', nameEn: 'Cappuccino', catId: 'cat_coffee', emoji: '☕', image: 'https://i.ibb.co/7MBQx0N/Cappuccino.png', prices: { S: 70, M: 80, L: 90 }, cost: 22, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 3, created: todayStr() },
    { id: 'm_mocha', name: 'มอคค่า', nameEn: 'Mocha', catId: 'cat_coffee', emoji: '🍫', image: 'https://i.ibb.co/nsZ0Zz6g/Mocha.png', prices: { S: 80, M: 90, L: 100 }, cost: 28, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 4, created: todayStr() },
    { id: 'm_caramel_macchiato', name: 'คาราเมล มัคคิอาโต้', nameEn: 'Caramel Macchiato', catId: 'cat_coffee', emoji: '🍯', image: 'https://i.ibb.co/sJ6Rxf4B/Caramel-Macchiato.png', prices: { S: 85, M: 95, L: 105 }, cost: 30, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 5, created: todayStr() },
    { id: 'm_white_mocha', name: 'ไวท์ช็อคโกแลต มอคค่า', nameEn: 'White Chocolate Mocha', catId: 'cat_coffee', emoji: '🤍', image: 'https://i.ibb.co/xqZcZ3dt/White-Chocolate-Mocha.png', prices: { S: 90, M: 100, L: 110 }, cost: 32, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 6, created: todayStr() },
    { id: 'm_espresso', name: 'เอสเพรสโซ่', nameEn: 'Espresso', catId: 'cat_coffee', emoji: '☕', image: 'https://i.ibb.co/0yjJ4kqh/Espresso.png', prices: { S: 50 }, cost: 12, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot'], allowSweetLevel: false, sort: 7, created: todayStr() },
    { id: 'm_iced_americano', name: 'อเมริกาโน่เย็น', nameEn: 'Iced Americano', catId: 'cat_coffee', emoji: '🧊', image: 'https://i.ibb.co/YBgSGFLh/Iced-Americano.png', prices: { S: 65, M: 75, L: 85 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced'], allowSweetLevel: true, sort: 8, created: todayStr() },
    /* ชา */
    { id: 'm_greentea', name: 'ชาเขียว', nameEn: 'Green Tea', catId: 'cat_tea', emoji: '🍵', image: 'https://i.ibb.co/7JK2mNkB/Green-Tea.png', prices: { S: 65, M: 75, L: 85 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 9, created: todayStr() },
    { id: 'm_thaitea', name: 'ชาไทย', nameEn: 'Thai Tea', catId: 'cat_tea', emoji: '🧋', image: 'https://i.ibb.co/3ythjkQp/Thai-Tea.png', prices: { S: 55, M: 65, L: 75 }, cost: 15, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 10, created: todayStr() },
    { id: 'm_lemontea', name: 'ชามะนาว', nameEn: 'Lemon Tea', catId: 'cat_tea', emoji: '🍋', image: 'https://i.ibb.co/Z9F2XHT/Lemon-Tea.png', prices: { S: 50, M: 60, L: 70 }, cost: 12, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced'], allowSweetLevel: true, sort: 11, created: todayStr() },
    { id: 'm_blacktea', name: 'ชาดำ', nameEn: 'Black Tea', catId: 'cat_tea', emoji: '🫖', image: 'https://i.ibb.co/ks9xnyjy/Black-Tea.png', prices: { S: 45, M: 55, L: 65 }, cost: 10, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 12, created: todayStr() },
    { id: 'm_milktea', name: 'ชานม', nameEn: 'Milk Tea', catId: 'cat_tea', emoji: '🥛', image: 'https://i.ibb.co/zH8VDJQw/Milk-Tea.png', prices: { S: 55, M: 65, L: 75 }, cost: 15, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 13, created: todayStr() },
    { id: 'm_matcha_latte', name: 'มัทฉะ ลาเต้', nameEn: 'Matcha Latte', catId: 'cat_tea', emoji: '🍵', image: 'https://i.ibb.co/ynTPfWdh/Matcha-Latte.png', prices: { S: 80, M: 90, L: 100 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 14, created: todayStr() },
    { id: 'm_greentea_latte', name: 'ชาเขียวนม', nameEn: 'Green Tea Latte', catId: 'cat_tea', emoji: '🍵🥛', image: 'https://i.ibb.co/JwGmDzWN/Green-Tea-Latte.png', prices: { S: 70, M: 80, L: 90 }, cost: 20, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 15, created: todayStr() },
    /* ปั่น */
    { id: 'm_cocoa', name: 'โกโก้', nameEn: 'Cocoa', catId: 'cat_blend', emoji: '🍫', image: 'https://i.ibb.co/5xzXyRvH/Cocoa.png', prices: { S: 75, M: 85, L: 95 }, cost: 20, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced', 'dt_blend'], allowSweetLevel: true, sort: 16, created: todayStr() },
    { id: 'm_hot_chocolate', name: 'ฮ็อตช็อคโกแลต', nameEn: 'Hot Chocolate', catId: 'cat_blend', emoji: '☕', image: 'https://i.ibb.co/yFhjptXD/Hot-Chocolate.png', prices: { S: 80, M: 90, L: 100 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot'], allowSweetLevel: true, sort: 17, created: todayStr() },
    { id: 'm_strawberry_smoothie', name: 'สมูทตี้สตรอเบอร์รี่', nameEn: 'Strawberry Smoothie', catId: 'cat_blend', emoji: '🍓', image: 'https://i.ibb.co/XxXBzXBG/Strawberry-Smoothie.png', prices: { S: 85, M: 95, L: 105 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 18, created: todayStr() },
    { id: 'm_blueberry_smoothie', name: 'สมูทตี้บลูเบอร์รี่', nameEn: 'Blueberry Smoothie', catId: 'cat_blend', emoji: '🫐', image: 'https://i.ibb.co/67YZn4jt/Blueberry-Smoothie.png', prices: { S: 85, M: 95, L: 105 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 19, created: todayStr() },
    { id: 'm_mango_smoothie', name: 'สมูทตี้มะม่วง', nameEn: 'Mango Smoothie', catId: 'cat_blend', emoji: '🥭', image: 'https://i.ibb.co/9ks2XMP5/Mango-Smoothie.png', prices: { S: 85, M: 95, L: 105 }, cost: 25, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 20, created: todayStr() },
    /* เบเกอรี่ */
    { id: 'm_croissant', name: 'ครัวซองค์', nameEn: 'Croissant', catId: 'cat_bakery', emoji: '🥐', image: 'https://i.ibb.co/qMpWL3ZK/Croissant.png', prices: { S: 65 }, cost: 25, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 21, created: todayStr() },
    { id: 'm_chocolate_cake', name: 'เค้กช็อกโกแลต', nameEn: 'Chocolate Cake', catId: 'cat_bakery', emoji: '🍰', image: 'https://i.ibb.co/hx3n2rGS/Chocolate-Cake.png', prices: { S: 120 }, cost: 40, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 22, created: todayStr() },
    { id: 'm_cookie', name: 'คุกกี้', nameEn: 'Cookie', catId: 'cat_bakery', emoji: '🍪', image: 'https://i.ibb.co/Y7SJgJnk/Cookie.png', prices: { S: 45 }, cost: 15, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 23, created: todayStr() },
    { id: 'm_brownie', name: 'บราวนี่', nameEn: 'Brownie', catId: 'cat_bakery', emoji: '🍫', image: 'https://i.ibb.co/nsW3r0nC/Brownie.png', prices: { S: 55 }, cost: 20, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 24, created: todayStr() },
    { id: 'm_cheesecake', name: 'ชีสเค้ก', nameEn: 'Cheesecake', catId: 'cat_bakery', emoji: '🧀', image: 'https://i.ibb.co/ycbWQ3SF/Cheesecake.png', prices: { S: 110 }, cost: 35, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 25, created: todayStr() },
    /* อื่นๆ */
    { id: 'm_water', name: 'น้ำเปล่า', nameEn: 'Water', catId: 'cat_other', emoji: '💧', image: 'https://i.ibb.co/j9cgz8nZ/Water.png', prices: { S: 20 }, cost: 5, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 26, created: todayStr() },
    { id: 'm_soda', name: 'น้ำอัดลม', nameEn: 'Soda', catId: 'cat_other', emoji: '🥤', image: 'https://i.ibb.co/jvWJnZcv/Soda.png', prices: { S: 35, M: 45 }, cost: 10, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 27, created: todayStr() },
    { id: 'm_juice', name: 'น้ำผลไม้', nameEn: 'Juice', catId: 'cat_other', emoji: '🧃', image: 'https://i.ibb.co/vvqY5qyZ/Juice.png', prices: { S: 45, M: 55 }, cost: 15, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 28, created: todayStr() },
    /* กาแฟ/ชาพิเศษ */
    { id: 'm_orange_americano', name: 'อเมริกาโน่ส้ม', nameEn: 'Orange Americano', catId: 'cat_coffee', emoji: '🍊', image: 'https://i.ibb.co/dJwC2WKL/Orange-Americano.png', prices: { S: 70, M: 80, L: 90 }, cost: 22, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced'], allowSweetLevel: true, sort: 29, created: todayStr() },
    { id: 'm_honey_americano', name: 'อเมริกาโน่น้ำผึ้ง', nameEn: 'Honey Americano', catId: 'cat_coffee', emoji: '🍯', image: 'https://i.ibb.co/twBtd7sx/Honey-Americano.png', prices: { S: 70, M: 80, L: 90 }, cost: 22, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 30, created: todayStr() },
    { id: 'm_peach_tea', name: 'ชาพีช', nameEn: 'Peach Tea', catId: 'cat_tea', emoji: '🍑', image: 'https://i.ibb.co/7thkLKvv/Peach-Tea.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_iced'], allowSweetLevel: true, sort: 31, created: todayStr() },
    { id: 'm_milktea2', name: 'ชานม', nameEn: 'Milk Tea', catId: 'cat_tea', emoji: '🧋', image: 'https://i.ibb.co/gC5j9vY/Milk-Tea.png', prices: { S: 55, M: 65, L: 75 }, cost: 15, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_hot', 'dt_iced'], allowSweetLevel: true, sort: 32, created: todayStr() },
    /* ปั่น */
    { id: 'm_cookies_cream_frappe', name: 'คุกกี้แอนด์ครีมปั่น', nameEn: 'Cookies & Cream Frappe', catId: 'cat_blend', emoji: '🍪', image: 'https://i.ibb.co/jZQfnJhj/Cookies-Cream-Frappe.png', prices: { S: 85, M: 95, L: 105 }, cost: 28, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 33, created: todayStr() },
    { id: 'm_caramel_frappe', name: 'คาราเมลปั่น', nameEn: 'Caramel Frappe', catId: 'cat_blend', emoji: '🍮', image: 'https://i.ibb.co/DD4yJg9g/Caramel-Frappe.png', prices: { S: 85, M: 95, L: 105 }, cost: 28, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 34, created: todayStr() },
    { id: 'm_matcha_frappe', name: 'ชาเขียวปั่น', nameEn: 'Matcha Frappe', catId: 'cat_blend', emoji: '🍵', image: 'https://i.ibb.co/YBLp1pxC/Matcha-Frappe.png', prices: { S: 85, M: 95, L: 105 }, cost: 28, active: true, allowDrinkType: true, availableDrinkTypes: ['dt_blend'], allowSweetLevel: true, sort: 35, created: todayStr() },
    /* โซดา */
    { id: 'm_strawberry_soda', name: 'สตรอว์เบอร์รีโซดา', nameEn: 'Strawberry Soda', catId: 'cat_other', emoji: '🍓', image: 'https://i.ibb.co/B2hQk3NN/Strawberry-Soda.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: false, allowSweetLevel: true, sort: 36, created: todayStr() },
    { id: 'm_passionfruit_soda', name: 'เสาวรสโซดา', nameEn: 'Passion Fruit Soda', catId: 'cat_other', emoji: '🟡', image: 'https://i.ibb.co/BKjCPwFC/Passion-Fruit-Soda.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: false, allowSweetLevel: true, sort: 37, created: todayStr() },
    { id: 'm_yuzu_soda', name: 'ยูซุโซดา', nameEn: 'Yuzu Soda', catId: 'cat_other', emoji: '🍋', image: 'https://i.ibb.co/RTmHV3Bt/Yuzu-Soda.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: false, allowSweetLevel: true, sort: 38, created: todayStr() },
    { id: 'm_lychee_soda', name: 'ลิ้นจี่โซดา', nameEn: 'Lychee Soda', catId: 'cat_other', emoji: '🍈', image: 'https://i.ibb.co/chmQ5jx6/Lychee-Soda.png', prices: { S: 60, M: 70, L: 80 }, cost: 18, active: true, allowDrinkType: false, allowSweetLevel: true, sort: 39, created: todayStr() },
    /* น้ำอัดลมขวด */
    { id: 'm_coke', name: 'โค้ก (ขวดแก้วฉลากแดง)', nameEn: 'Coke (Red Label Glass Bottle)', catId: 'cat_other', emoji: '🥤', image: 'https://i.ibb.co/chcRFw1L/Coke.png', prices: { S: 25 }, cost: 12, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 40, created: todayStr() },
    { id: 'm_fanta_orange', name: 'แฟนต้าน้ำส้ม (ขวดแก้วฉลากส้ม)', nameEn: 'Fanta Orange (Orange Label Glass Bottle)', catId: 'cat_other', emoji: '🥤', image: 'https://i.ibb.co/4gnZLtbh/Orange-Fanta.png', prices: { S: 25 }, cost: 12, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 41, created: todayStr() },
    { id: 'm_pepsi', name: 'เป๊ปซี่ (ขวดแก้วฉลากน้ำเงิน)', nameEn: 'Pepsi (Blue Label Glass Bottle)', catId: 'cat_other', emoji: '🥤', image: 'https://i.ibb.co/846X78Wd/Pepsi.png', prices: { S: 25 }, cost: 12, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 42, created: todayStr() },
    /* เครื่องดื่มชูกำลัง */
    { id: 'm_m150', name: 'เอ็ม-150 (ขวดแก้วสีชา ฉลากเหลือง-แดง)', nameEn: 'M-150 (Brown Glass Bottle, Yellow-Red Label)', catId: 'cat_energy', emoji: '⚡', image: 'https://i.ibb.co/93rqMvt5/M-150.png', prices: { S: 25 }, cost: 13, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 43, created: todayStr() },
    { id: 'm_redbull', name: 'กระทิงแดง (ขวดแก้วสีชา ฉลากน้ำเงิน-เงิน)', nameEn: 'Krating Daeng (Brown Glass Bottle, Blue-Silver Label)', catId: 'cat_energy', emoji: '⚡', image: 'https://i.ibb.co/TxqjjjZb/image.png', prices: { S: 25 }, cost: 13, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 44, created: todayStr() },
    { id: 'm_lipo', name: 'ลิโพ (ขวดแก้วสีชา ฉลากขาว-น้ำเงิน)', nameEn: 'Lipovitan (Brown Glass Bottle, White-Blue Label)', catId: 'cat_energy', emoji: '⚡', image: 'https://i.ibb.co/sd4bJZTq/image.png', prices: { S: 25 }, cost: 13, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 45, created: todayStr() },
    /* แอลกอฮอล์ */
    { id: 'm_beer_brown', name: 'เบียร์ขวดแก้วสีชา (สิงห์/ลีโอ)', nameEn: 'Beer - Brown Bottle (Singha/Leo)', catId: 'cat_alcohol', emoji: '🍺', image: 'https://i.ibb.co/WW4rR5tQ/image.png', prices: { S: 70 }, cost: 35, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 46, created: todayStr() },
    { id: 'm_beer_green', name: 'เบียร์ขวดแก้วสีเขียว (ไฮเนเก้น/ช้าง)', nameEn: 'Beer - Green Bottle (Heineken/Chang)', catId: 'cat_alcohol', emoji: '🍺', image: 'https://i.ibb.co/8Db8Z107/image.png', prices: { S: 70 }, cost: 35, active: true, allowDrinkType: false, allowSweetLevel: false, sort: 47, created: todayStr() }
  ];
